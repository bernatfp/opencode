        ...
        <box flexGrow={1} paddingBottom={1} paddingTop={1} paddingLeft={2} paddingRight={2} gap={1}>
          <Show when={session()}>
            ...
            <box flexShrink={0}>
              ...
              <Prompt
                visible={!session()?.parentID && permissions().length === 0 && questions().length === 0 && secureInputs().length === 0}
                ref={(r) => {
                  prompt = r
                  promptRef.set(r)
                ...
                disabled={permissions().length > 0 || questions().length > 0 || secureInputs().length > 0}
                onSubmit={() => {
                  toBottom()
                }}
                sessionID={route.sessionID}
